...
class Level:
    ...
    def show(self, scr, notification):
        filename = helpers.path_from_root('graphics/styles/{0}.txt'.format(self.location.style.lower()))
        ...
        helpers.centered_print(scr, text, upper=level_text)
